...
MessageBuilder.prototype.varIntSize = function varIntSize(num) {
  if (num < 0xfd) {
    return 1
  } else if (num <= 0xffff) {
    return 3
...
MessageBuilder.prototype.getVarInt = function getVarInt(buff, offset) {
...
MessageBuilder.prototype.getVarString = function getVarString(buff, offset) {
